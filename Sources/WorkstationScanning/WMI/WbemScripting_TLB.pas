...
// $Rev: 17244 $
// File generated on 03.10.2010 23:26:17 from Type Library described below.
...
//   Error creating palette bitmap of (TSWbemServices) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemServicesEx) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemObject) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemObjectEx) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemObjectSet) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemNamedValue) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemQualifier) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemQualifierSet) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemProperty) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemPropertySet) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemMethod) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemMethodSet) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemEventSource) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemSecurity) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemPrivilege) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemPrivilegeSet) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
//   Error creating palette bitmap of (TSWbemRefreshableItem) : Server C:\Windows\system32\wbem\wbemdisp.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemServices
// Help String      : A connection to a Namespace
// Default Interface: ISWbemServices
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemServicesProperties= class;
{$ENDIF}
  TSWbemServices = class(TOleServer)
  private
    FIntf: ISWbemServices;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemServicesProperties;
    function GetServerProperties: TSWbemServicesProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemServices;
  protected
    procedure InitServerData; override;
    function Get_Security_: ISWbemSecurity;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemServices);
    procedure Disconnect; override;
    function Get(const strObjectPath: WideString; iFlags: Integer; 
    ...
    procedure ReferencesToAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                                ...
                                const objWbemAsyncContext: IDispatch);
    function ExecNotificationQuery(const strQuery: WideString; const strQueryLanguage: WideString; 
                                   iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemEventSource;
    procedure ExecNotificationQueryAsync(const objWbemSink: IDispatch; const strQuery: WideString; 
                                         const strQueryLanguage: WideString; iFlags: Integer; 
                                         const objWbemNamedValueSet: IDispatch; 
                                         const objWbemAsyncContext: IDispatch);
    ...
    procedure ExecMethodAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                              ...
                              const objWbemNamedValueSet: IDispatch; 
                              const objWbemAsyncContext: IDispatch);
    property DefaultInterface: ISWbemServices read GetDefaultInterface;
    property Security_: ISWbemSecurity read Get_Security_;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemServicesProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemServicesProperties = class(TPersistent)
  private
    FServer:    TSWbemServices;
    function    GetDefaultInterface: ISWbemServices;
    constructor Create(AServer: TSWbemServices);
  protected
    function Get_Security_: ISWbemSecurity;
  public
    property DefaultInterface: ISWbemServices read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemServicesEx
// Help String      : A connection to a Namespace
// Default Interface: ISWbemServicesEx
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemServicesExProperties= class;
{$ENDIF}
  TSWbemServicesEx = class(TOleServer)
  private
    FIntf: ISWbemServicesEx;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemServicesExProperties;
    function GetServerProperties: TSWbemServicesExProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemServicesEx;
  protected
    procedure InitServerData; override;
    function Get_Security_: ISWbemSecurity;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemServicesEx);
    procedure Disconnect; override;
    function Get(const strObjectPath: WideString; iFlags: Integer; 
                 const objWbemNamedValueSet: IDispatch): ISWbemObject;
    procedure GetAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
    ...
    procedure ExecMethodAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                              ...
                              const objWbemAsyncContext: IDispatch);
    function Put(const objWbemObject: ISWbemObjectEx; iFlags: Integer; 
                 const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
    procedure PutAsync(const objWbemSink: ISWbemSink; const objWbemObject: ISWbemObjectEx; 
                       iFlags: Integer; const objWbemNamedValueSet: IDispatch; 
                       const objWbemAsyncContext: IDispatch);
    property DefaultInterface: ISWbemServicesEx read GetDefaultInterface;
    property Security_: ISWbemSecurity read Get_Security_;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemServicesExProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemServicesExProperties = class(TPersistent)
  private
    FServer:    TSWbemServicesEx;
    function    GetDefaultInterface: ISWbemServicesEx;
    constructor Create(AServer: TSWbemServicesEx);
  protected
    function Get_Security_: ISWbemSecurity;
  public
    property DefaultInterface: ISWbemServicesEx read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemObject
// Help String      : A Class or Instance
// Default Interface: ISWbemObject
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemObjectProperties= class;
{$ENDIF}
  TSWbemObject = class(TOleServer)
  private
    FIntf: ISWbemObject;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemObjectProperties;
    function GetServerProperties: TSWbemObjectProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemObject;
  protected
    procedure InitServerData; override;
    function Get_Qualifiers_: ISWbemQualifierSet;
    function Get_Properties_: ISWbemPropertySet;
  ...
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemObject);
    procedure Disconnect; override;
    function Put_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
    procedure PutAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                        const objWbemNamedValueSet: IDispatch; const objWbemAsyncContext: IDispatch);
    ...
    function SpawnInstance_(iFlags: Integer): ISWbemObject;
    function CompareTo_(const objWbemObject: IDispatch; iFlags: Integer): WordBool;
    property DefaultInterface: ISWbemObject read GetDefaultInterface;
    property Qualifiers_: ISWbemQualifierSet read Get_Qualifiers_;
    property Properties_: ISWbemPropertySet read Get_Properties_;
    property Methods_: ISWbemMethodSet read Get_Methods_;
    property Derivation_: OleVariant read Get_Derivation_;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemObjectProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemObjectProperties = class(TPersistent)
  private
    FServer:    TSWbemObject;
    function    GetDefaultInterface: ISWbemObject;
    constructor Create(AServer: TSWbemObject);
  protected
    function Get_Qualifiers_: ISWbemQualifierSet;
    function Get_Properties_: ISWbemPropertySet;
    function Get_Methods_: ISWbemMethodSet;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemObjectEx
// Help String      : A Class or Instance
// Default Interface: ISWbemObjectEx
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemObjectExProperties= class;
{$ENDIF}
  TSWbemObjectEx = class(TOleServer)
  private
    FIntf: ISWbemObjectEx;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemObjectExProperties;
    function GetServerProperties: TSWbemObjectExProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemObjectEx;
  protected
    procedure InitServerData; override;
    function Get_Qualifiers_: ISWbemQualifierSet;
    function Get_Properties_: ISWbemPropertySet;
    ...
    function Get_Path_: ISWbemObjectPath;
    function Get_Security_: ISWbemSecurity;
    function Get_SystemProperties_: ISWbemPropertySet;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemObjectEx);
    procedure Disconnect; override;
    function Put_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
    procedure PutAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                        const objWbemNamedValueSet: IDispatch; const objWbemAsyncContext: IDispatch);
    ...
    function SpawnInstance_(iFlags: Integer): ISWbemObject;
    function CompareTo_(const objWbemObject: IDispatch; iFlags: Integer): WordBool;
    procedure Refresh_(iFlags: Integer; const objWbemNamedValueSet: IDispatch);
    function GetText_(iObjectTextFormat: WbemObjectTextFormatEnum; iFlags: Integer; 
                      const objWbemNamedValueSet: IDispatch): WideString;
    procedure SetFromText_(const bsText: WideString; iObjectTextFormat: WbemObjectTextFormatEnum; 
                           iFlags: Integer; const objWbemNamedValueSet: IDispatch);
    property DefaultInterface: ISWbemObjectEx read GetDefaultInterface;
    property Qualifiers_: ISWbemQualifierSet read Get_Qualifiers_;
    property Properties_: ISWbemPropertySet read Get_Properties_;
    property Methods_: ISWbemMethodSet read Get_Methods_;
    property Derivation_: OleVariant read Get_Derivation_;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemObjectExProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemObjectExProperties = class(TPersistent)
  private
    FServer:    TSWbemObjectEx;
    function    GetDefaultInterface: ISWbemObjectEx;
    constructor Create(AServer: TSWbemObjectEx);
  protected
    function Get_Qualifiers_: ISWbemQualifierSet;
    function Get_Properties_: ISWbemPropertySet;
    function Get_Methods_: ISWbemMethodSet;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemObjectSet
// Help String      : A collection of Classes or Instances
// Default Interface: ISWbemObjectSet
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemObjectSetProperties= class;
{$ENDIF}
  TSWbemObjectSet = class(TOleServer)
  private
    FIntf: ISWbemObjectSet;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemObjectSetProperties;
    function GetServerProperties: TSWbemObjectSetProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemObjectSet;
  protected
    procedure InitServerData; override;
    function Get_Count: Integer;
    function Get_Security_: ISWbemSecurity;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemObjectSet);
    procedure Disconnect; override;
    function Item(const strObjectPath: WideString; iFlags: Integer): ISWbemObject;
    function ItemIndex(lIndex: Integer): ISWbemObject;
    property DefaultInterface: ISWbemObjectSet read GetDefaultInterface;
    property Count: Integer read Get_Count;
    property Security_: ISWbemSecurity read Get_Security_;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemObjectSetProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemObjectSetProperties = class(TPersistent)
  private
    FServer:    TSWbemObjectSet;
    function    GetDefaultInterface: ISWbemObjectSet;
    constructor Create(AServer: TSWbemObjectSet);
  protected
    function Get_Count: Integer;
    function Get_Security_: ISWbemSecurity;
  public
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemNamedValue
// Help String      : A named value
// Default Interface: ISWbemNamedValue
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemNamedValueProperties= class;
{$ENDIF}
  TSWbemNamedValue = class(TOleServer)
  private
    FIntf: ISWbemNamedValue;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemNamedValueProperties;
    function GetServerProperties: TSWbemNamedValueProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemNamedValue;
  protected
    procedure InitServerData; override;
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    function Get_Name: WideString;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemNamedValue);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemNamedValue read GetDefaultInterface;
    property Name: WideString read Get_Name;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemNamedValueProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemNamedValueProperties = class(TPersistent)
  private
    FServer:    TSWbemNamedValue;
    function    GetDefaultInterface: ISWbemNamedValue;
    constructor Create(AServer: TSWbemNamedValue);
  protected
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    function Get_Name: WideString;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemQualifier
// Help String      : A Qualifier
// Default Interface: ISWbemQualifier
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemQualifierProperties= class;
{$ENDIF}
  TSWbemQualifier = class(TOleServer)
  private
    FIntf: ISWbemQualifier;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemQualifierProperties;
    function GetServerProperties: TSWbemQualifierProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemQualifier;
  protected
    procedure InitServerData; override;
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    ...
    function Get_PropagatesToSubclass: WordBool;
    procedure Set_PropagatesToSubclass(bPropagatesToSubclass: WordBool);
    function Get_PropagatesToInstance: WordBool;
    procedure Set_PropagatesToInstance(bPropagatesToInstance: WordBool);
    function Get_IsOverridable: WordBool;
    procedure Set_IsOverridable(bIsOverridable: WordBool);
    function Get_IsAmended: WordBool;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemQualifier);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemQualifier read GetDefaultInterface;
    property Name: WideString read Get_Name;
    property IsLocal: WordBool read Get_IsLocal;
    property IsAmended: WordBool read Get_IsAmended;
    property PropagatesToSubclass: WordBool read Get_PropagatesToSubclass write Set_PropagatesToSubclass;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemQualifierProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemQualifierProperties = class(TPersistent)
  private
    FServer:    TSWbemQualifier;
    function    GetDefaultInterface: ISWbemQualifier;
    constructor Create(AServer: TSWbemQualifier);
  protected
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    function Get_Name: WideString;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemQualifierSet
// Help String      : A collection of Qualifiers
// Default Interface: ISWbemQualifierSet
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemQualifierSetProperties= class;
{$ENDIF}
  TSWbemQualifierSet = class(TOleServer)
  private
    FIntf: ISWbemQualifierSet;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemQualifierSetProperties;
    function GetServerProperties: TSWbemQualifierSetProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemQualifierSet;
  protected
    procedure InitServerData; override;
    function Get_Count: Integer;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemQualifierSet);
    procedure Disconnect; override;
    function Item(const Name: WideString; iFlags: Integer): ISWbemQualifier;
    function Add(const strName: WideString; var varVal: OleVariant; 
                 bPropagatesToSubclass: WordBool; bPropagatesToInstance: WordBool; 
                 bIsOverridable: WordBool; iFlags: Integer): ISWbemQualifier;
    procedure Remove(const strName: WideString; iFlags: Integer);
    property DefaultInterface: ISWbemQualifierSet read GetDefaultInterface;
    property Count: Integer read Get_Count;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemQualifierSetProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemQualifierSetProperties = class(TPersistent)
  private
    FServer:    TSWbemQualifierSet;
    function    GetDefaultInterface: ISWbemQualifierSet;
    constructor Create(AServer: TSWbemQualifierSet);
  protected
    function Get_Count: Integer;
  public
    property DefaultInterface: ISWbemQualifierSet read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemProperty
// Help String      : A Property
// Default Interface: ISWbemProperty
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemPropertyProperties= class;
{$ENDIF}
  TSWbemProperty = class(TOleServer)
  private
    FIntf: ISWbemProperty;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemPropertyProperties;
    function GetServerProperties: TSWbemPropertyProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemProperty;
  protected
    procedure InitServerData; override;
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    function Get_Name: WideString;
    function Get_IsLocal: WordBool;
    function Get_Origin: WideString;
    function Get_CIMType: WbemCimtypeEnum;
    function Get_Qualifiers_: ISWbemQualifierSet;
    function Get_IsArray: WordBool;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemProperty);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemProperty read GetDefaultInterface;
    property Name: WideString read Get_Name;
    property IsLocal: WordBool read Get_IsLocal;
    property Origin: WideString read Get_Origin;
    property CIMType: WbemCimtypeEnum read Get_CIMType;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemPropertyProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemPropertyProperties = class(TPersistent)
  private
    FServer:    TSWbemProperty;
    function    GetDefaultInterface: ISWbemProperty;
    constructor Create(AServer: TSWbemProperty);
  protected
    function Get_Value: OleVariant;
    procedure Set_Value(var varValue: OleVariant);
    function Get_Name: WideString;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemPropertySet
// Help String      : A collection of Properties
// Default Interface: ISWbemPropertySet
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemPropertySetProperties= class;
{$ENDIF}
  TSWbemPropertySet = class(TOleServer)
  private
    FIntf: ISWbemPropertySet;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemPropertySetProperties;
    function GetServerProperties: TSWbemPropertySetProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemPropertySet;
  protected
    procedure InitServerData; override;
    function Get_Count: Integer;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemPropertySet);
    procedure Disconnect; override;
    function Item(const strName: WideString; iFlags: Integer): ISWbemProperty;
    function Add(const strName: WideString; iCimType: WbemCimtypeEnum; bIsArray: WordBool; 
                 iFlags: Integer): ISWbemProperty;
    procedure Remove(const strName: WideString; iFlags: Integer);
    property DefaultInterface: ISWbemPropertySet read GetDefaultInterface;
    property Count: Integer read Get_Count;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemPropertySetProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemPropertySetProperties = class(TPersistent)
  private
    FServer:    TSWbemPropertySet;
    function    GetDefaultInterface: ISWbemPropertySet;
    constructor Create(AServer: TSWbemPropertySet);
  protected
    function Get_Count: Integer;
  public
    property DefaultInterface: ISWbemPropertySet read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemMethod
// Help String      : A Method
// Default Interface: ISWbemMethod
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemMethodProperties= class;
{$ENDIF}
  TSWbemMethod = class(TOleServer)
  private
    FIntf: ISWbemMethod;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemMethodProperties;
    function GetServerProperties: TSWbemMethodProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemMethod;
  protected
    procedure InitServerData; override;
    function Get_Name: WideString;
    function Get_Origin: WideString;
    function Get_InParameters: ISWbemObject;
    function Get_OutParameters: ISWbemObject;
    function Get_Qualifiers_: ISWbemQualifierSet;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemMethod);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemMethod read GetDefaultInterface;
    property Name: WideString read Get_Name;
    property Origin: WideString read Get_Origin;
    property InParameters: ISWbemObject read Get_InParameters;
    property OutParameters: ISWbemObject read Get_OutParameters;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemMethodProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemMethodProperties = class(TPersistent)
  private
    FServer:    TSWbemMethod;
    function    GetDefaultInterface: ISWbemMethod;
    constructor Create(AServer: TSWbemMethod);
  protected
    function Get_Name: WideString;
    function Get_Origin: WideString;
    function Get_InParameters: ISWbemObject;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemMethodSet
// Help String      : A collection of Methods
// Default Interface: ISWbemMethodSet
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemMethodSetProperties= class;
{$ENDIF}
  TSWbemMethodSet = class(TOleServer)
  private
    FIntf: ISWbemMethodSet;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemMethodSetProperties;
    function GetServerProperties: TSWbemMethodSetProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemMethodSet;
  protected
    procedure InitServerData; override;
    function Get_Count: Integer;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemMethodSet);
    procedure Disconnect; override;
    function Item(const strName: WideString; iFlags: Integer): ISWbemMethod;
    property DefaultInterface: ISWbemMethodSet read GetDefaultInterface;
    property Count: Integer read Get_Count;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemMethodSetProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemMethodSetProperties = class(TPersistent)
  private
    FServer:    TSWbemMethodSet;
    function    GetDefaultInterface: ISWbemMethodSet;
    constructor Create(AServer: TSWbemMethodSet);
  protected
    function Get_Count: Integer;
  public
    property DefaultInterface: ISWbemMethodSet read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemEventSource
// Help String      : An Event source
// Default Interface: ISWbemEventSource
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemEventSourceProperties= class;
{$ENDIF}
  TSWbemEventSource = class(TOleServer)
  private
    FIntf: ISWbemEventSource;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemEventSourceProperties;
    function GetServerProperties: TSWbemEventSourceProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemEventSource;
  protected
    procedure InitServerData; override;
    function Get_Security_: ISWbemSecurity;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemEventSource);
    procedure Disconnect; override;
    function NextEvent(iTimeoutMs: Integer): ISWbemObject;
    property DefaultInterface: ISWbemEventSource read GetDefaultInterface;
    property Security_: ISWbemSecurity read Get_Security_;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemEventSourceProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemEventSourceProperties = class(TPersistent)
  private
    FServer:    TSWbemEventSource;
    function    GetDefaultInterface: ISWbemEventSource;
    constructor Create(AServer: TSWbemEventSource);
  protected
    function Get_Security_: ISWbemSecurity;
  public
    property DefaultInterface: ISWbemEventSource read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemSecurity
// Help String      : A Security Configurator
// Default Interface: ISWbemSecurity
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemSecurityProperties= class;
{$ENDIF}
  TSWbemSecurity = class(TOleServer)
  private
    FIntf: ISWbemSecurity;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemSecurityProperties;
    function GetServerProperties: TSWbemSecurityProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemSecurity;
  protected
    procedure InitServerData; override;
    function Get_ImpersonationLevel: WbemImpersonationLevelEnum;
    procedure Set_ImpersonationLevel(iImpersonationLevel: WbemImpersonationLevelEnum);
    function Get_AuthenticationLevel: WbemAuthenticationLevelEnum;
    procedure Set_AuthenticationLevel(iAuthenticationLevel: WbemAuthenticationLevelEnum);
    function Get_Privileges: ISWbemPrivilegeSet;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemSecurity);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemSecurity read GetDefaultInterface;
    property Privileges: ISWbemPrivilegeSet read Get_Privileges;
    property ImpersonationLevel: WbemImpersonationLevelEnum read Get_ImpersonationLevel write Set_ImpersonationLevel;
    property AuthenticationLevel: WbemAuthenticationLevelEnum read Get_AuthenticationLevel write Set_AuthenticationLevel;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemSecurityProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemSecurityProperties = class(TPersistent)
  private
    FServer:    TSWbemSecurity;
    function    GetDefaultInterface: ISWbemSecurity;
    constructor Create(AServer: TSWbemSecurity);
  protected
    function Get_ImpersonationLevel: WbemImpersonationLevelEnum;
    procedure Set_ImpersonationLevel(iImpersonationLevel: WbemImpersonationLevelEnum);
    function Get_AuthenticationLevel: WbemAuthenticationLevelEnum;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemPrivilege
// Help String      : A Privilege Override
// Default Interface: ISWbemPrivilege
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemPrivilegeProperties= class;
{$ENDIF}
  TSWbemPrivilege = class(TOleServer)
  private
    FIntf: ISWbemPrivilege;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemPrivilegeProperties;
    function GetServerProperties: TSWbemPrivilegeProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemPrivilege;
  protected
    procedure InitServerData; override;
    function Get_IsEnabled: WordBool;
    procedure Set_IsEnabled(bIsEnabled: WordBool);
    function Get_Name: WideString;
    function Get_DisplayName: WideString;
    function Get_Identifier: WbemPrivilegeEnum;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemPrivilege);
    procedure Disconnect; override;
    property DefaultInterface: ISWbemPrivilege read GetDefaultInterface;
    property Name: WideString read Get_Name;
    property DisplayName: WideString read Get_DisplayName;
    property Identifier: WbemPrivilegeEnum read Get_Identifier;
    property IsEnabled: WordBool read Get_IsEnabled write Set_IsEnabled;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemPrivilegeProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemPrivilegeProperties = class(TPersistent)
  private
    FServer:    TSWbemPrivilege;
    function    GetDefaultInterface: ISWbemPrivilege;
    constructor Create(AServer: TSWbemPrivilege);
  protected
    function Get_IsEnabled: WordBool;
    procedure Set_IsEnabled(bIsEnabled: WordBool);
    function Get_Name: WideString;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemPrivilegeSet
// Help String      : A collection of Privilege Overrides
// Default Interface: ISWbemPrivilegeSet
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemPrivilegeSetProperties= class;
{$ENDIF}
  TSWbemPrivilegeSet = class(TOleServer)
  private
    FIntf: ISWbemPrivilegeSet;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemPrivilegeSetProperties;
    function GetServerProperties: TSWbemPrivilegeSetProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemPrivilegeSet;
  protected
    procedure InitServerData; override;
    function Get_Count: Integer;
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemPrivilegeSet);
    procedure Disconnect; override;
    function Item(iPrivilege: WbemPrivilegeEnum): ISWbemPrivilege;
    function Add(iPrivilege: WbemPrivilegeEnum; bIsEnabled: WordBool): ISWbemPrivilege;
    procedure Remove(iPrivilege: WbemPrivilegeEnum);
    procedure DeleteAll;
    function AddAsString(const strPrivilege: WideString; bIsEnabled: WordBool): ISWbemPrivilege;
    property DefaultInterface: ISWbemPrivilegeSet read GetDefaultInterface;
    property Count: Integer read Get_Count;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemPrivilegeSetProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemPrivilegeSetProperties = class(TPersistent)
  private
    FServer:    TSWbemPrivilegeSet;
    function    GetDefaultInterface: ISWbemPrivilegeSet;
    constructor Create(AServer: TSWbemPrivilegeSet);
  protected
    function Get_Count: Integer;
  public
    property DefaultInterface: ISWbemPrivilegeSet read GetDefaultInterface;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSWbemRefreshableItem
// Help String      : A single item from a Refresher
// Default Interface: ISWbemRefreshableItem
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TSWbemRefreshableItemProperties= class;
{$ENDIF}
  TSWbemRefreshableItem = class(TOleServer)
  private
    FIntf: ISWbemRefreshableItem;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TSWbemRefreshableItemProperties;
    function GetServerProperties: TSWbemRefreshableItemProperties;
{$ENDIF}
    function GetDefaultInterface: ISWbemRefreshableItem;
  protected
    procedure InitServerData; override;
    function Get_Index: Integer;
    function Get_Refresher: ISWbemRefresher;
    function Get_IsSet: WordBool;
    function Get_Object_: ISWbemObjectEx;
    function Get_ObjectSet: ISWbemObjectSet;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: ISWbemRefreshableItem);
    procedure Disconnect; override;
    procedure Remove(iFlags: Integer);
    property DefaultInterface: ISWbemRefreshableItem read GetDefaultInterface;
    property Index: Integer read Get_Index;
    property Refresher: ISWbemRefresher read Get_Refresher;
    property IsSet: WordBool read Get_IsSet;
    property Object_: ISWbemObjectEx read Get_Object_;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TSWbemRefreshableItemProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TSWbemRefreshableItemProperties = class(TPersistent)
  private
    FServer:    TSWbemRefreshableItem;
    function    GetDefaultInterface: ISWbemRefreshableItem;
    constructor Create(AServer: TSWbemRefreshableItem);
  protected
    function Get_Index: Integer;
    function Get_Refresher: ISWbemRefresher;
    function Get_IsSet: WordBool;
...
procedure TSWbemServices.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D63-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{76A6415C-CB41-11D1-8B02-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemServices.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemServices;
  end;
end;

procedure TSWbemServices.ConnectTo(svrIntf: ISWbemServices);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemServices.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemServices.GetDefaultInterface: ISWbemServices;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemServices.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemServicesProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemServices.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemServices.GetServerProperties: TSWbemServicesProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemServices.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemServices.Get(const strObjectPath: WideString; iFlags: Integer; 
                            const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
  Result := DefaultInterface.Get(strObjectPath, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServices.GetAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                                  iFlags: Integer; const objWbemNamedValueSet: IDispatch; 
                                  const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.GetAsync(objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, 
                            objWbemAsyncContext);
end;

procedure TSWbemServices.Delete(const strObjectPath: WideString; iFlags: Integer; 
                                const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.Delete(strObjectPath, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServices.DeleteAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                                     iFlags: Integer; const objWbemNamedValueSet: IDispatch; 
                                     const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.DeleteAsync(objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, 
                               objWbemAsyncContext);
end;

function TSWbemServices.InstancesOf(const strClass: WideString; iFlags: Integer; 
                                    const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.InstancesOf(strClass, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServices.InstancesOfAsync(const objWbemSink: IDispatch; const strClass: WideString; 
                                          iFlags: Integer; const objWbemNamedValueSet: IDispatch; 
                                          const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.InstancesOfAsync(objWbemSink, strClass, iFlags, objWbemNamedValueSet, 
                                    objWbemAsyncContext);
end;

function TSWbemServices.SubclassesOf(const strSuperclass: WideString; iFlags: Integer; 
                                     const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.SubclassesOf(strSuperclass, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServices.SubclassesOfAsync(const objWbemSink: IDispatch; 
                                           const strSuperclass: WideString; iFlags: Integer; 
                                           const objWbemNamedValueSet: IDispatch; 
                                           const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.SubclassesOfAsync(objWbemSink, strSuperclass, iFlags, objWbemNamedValueSet, 
                                     objWbemAsyncContext);
end;

function TSWbemServices.ExecQuery(const strQuery: WideString; const strQueryLanguage: WideString; 
                                  iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.ExecQuery(strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServices.ExecQueryAsync(const objWbemSink: IDispatch; const strQuery: WideString; 
                                        const strQueryLanguage: WideString; lFlags: Integer; 
                                        const objWbemNamedValueSet: IDispatch; 
                                        const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.ExecQueryAsync(objWbemSink, strQuery, strQueryLanguage, lFlags, 
                                  objWbemNamedValueSet, objWbemAsyncContext);
end;

function TSWbemServices.AssociatorsOf(const strObjectPath: WideString; 
                                      const strAssocClass: WideString; 
                                      const strResultClass: WideString; 
                                      const strResultRole: WideString; const strRole: WideString; 
                                      bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                      ...
                                      const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.AssociatorsOf(strObjectPath, strAssocClass, strResultClass, 
                                           strResultRole, strRole, bClassesOnly, bSchemaOnly, 
                                           strRequiredAssocQualifier, strRequiredQualifier, iFlags, 
                                           objWbemNamedValueSet);
end;

procedure TSWbemServices.AssociatorsOfAsync(const objWbemSink: IDispatch; 
                                            const strObjectPath: WideString; 
                                            const strAssocClass: WideString; 
                                            const strResultClass: WideString; 
                                            const strResultRole: WideString; 
                                            const strRole: WideString; bClassesOnly: WordBool; 
                                            ...
                                            const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.AssociatorsOfAsync(objWbemSink, strObjectPath, strAssocClass, strResultClass, 
                                      strResultRole, strRole, bClassesOnly, bSchemaOnly, 
                                      strRequiredAssocQualifier, strRequiredQualifier, iFlags, 
                                      objWbemNamedValueSet, objWbemAsyncContext);
end;

function TSWbemServices.ReferencesTo(const strObjectPath: WideString; 
                                     const strResultClass: WideString; const strRole: WideString; 
                                     bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                     const strRequiredQualifier: WideString; iFlags: Integer; 
                                     const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.ReferencesTo(strObjectPath, strResultClass, strRole, bClassesOnly, 
                                          bSchemaOnly, strRequiredQualifier, iFlags, 
                                          objWbemNamedValueSet);
end;

procedure TSWbemServices.ReferencesToAsync(const objWbemSink: IDispatch; 
                                           const strObjectPath: WideString; 
                                           const strResultClass: WideString; 
                                           const strRole: WideString; bClassesOnly: WordBool; 
                                           bSchemaOnly: WordBool; 
                                           ...
                                           const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.ReferencesToAsync(objWbemSink, strObjectPath, strResultClass, strRole, 
                                     bClassesOnly, bSchemaOnly, strRequiredQualifier, iFlags, 
                                     objWbemNamedValueSet, objWbemAsyncContext);
end;

function TSWbemServices.ExecNotificationQuery(const strQuery: WideString; 
                                              const strQueryLanguage: WideString; iFlags: Integer; 
                                              const objWbemNamedValueSet: IDispatch): ISWbemEventSource;
begin
  Result := DefaultInterface.ExecNotificationQuery(strQuery, strQueryLanguage, iFlags, 
                                                   objWbemNamedValueSet);
end;

procedure TSWbemServices.ExecNotificationQueryAsync(const objWbemSink: IDispatch; 
                                                    const strQuery: WideString; 
                                                    const strQueryLanguage: WideString; 
                                                    iFlags: Integer; 
                                                    const objWbemNamedValueSet: IDispatch; 
                                                    const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.ExecNotificationQueryAsync(objWbemSink, strQuery, strQueryLanguage, iFlags, 
                                              objWbemNamedValueSet, objWbemAsyncContext);
end;

function TSWbemServices.ExecMethod(const strObjectPath: WideString; 
                                   const strMethodName: WideString; 
                                   const objWbemInParameters: IDispatch; iFlags: Integer; 
                                   const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
  Result := DefaultInterface.ExecMethod(strObjectPath, strMethodName, objWbemInParameters, iFlags, 
                                        objWbemNamedValueSet);
end;

procedure TSWbemServices.ExecMethodAsync(const objWbemSink: IDispatch; 
                                         const strObjectPath: WideString; 
                                         const strMethodName: WideString; 
                                         const objWbemInParameters: IDispatch; iFlags: Integer; 
                                         const objWbemNamedValueSet: IDispatch; 
                                         const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.ExecMethodAsync(objWbemSink, strObjectPath, strMethodName, objWbemInParameters, 
                                   iFlags, objWbemNamedValueSet, objWbemAsyncContext);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemServicesProperties.Create(AServer: TSWbemServices);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemServicesProperties.GetDefaultInterface: ISWbemServices;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemServicesProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;
...
procedure TSWbemServicesEx.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{62E522DC-8CF3-40A8-8B2E-37D595651E40}';
    IntfIID:   '{D2F68443-85DC-427E-91D8-366554CC754C}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemServicesEx.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemServicesEx;
  end;
end;

procedure TSWbemServicesEx.ConnectTo(svrIntf: ISWbemServicesEx);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemServicesEx.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemServicesEx.GetDefaultInterface: ISWbemServicesEx;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemServicesEx.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemServicesExProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemServicesEx.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemServicesEx.GetServerProperties: TSWbemServicesExProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemServicesEx.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemServicesEx.Get(const strObjectPath: WideString; iFlags: Integer; 
                              const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
  Result := DefaultInterface.Get(strObjectPath, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.GetAsync(const objWbemSink: IDispatch; const strObjectPath: WideString; 
                                    iFlags: Integer; const objWbemNamedValueSet: IDispatch; 
                                    const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.GetAsync(objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, 
...
procedure TSWbemServicesEx.Delete(const strObjectPath: WideString; iFlags: Integer; 
                                  const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.Delete(strObjectPath, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.DeleteAsync(const objWbemSink: IDispatch; 
                                       const strObjectPath: WideString; iFlags: Integer; 
                                       const objWbemNamedValueSet: IDispatch; 
                                       const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.DeleteAsync(objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, 
...
function TSWbemServicesEx.InstancesOf(const strClass: WideString; iFlags: Integer; 
                                      const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.InstancesOf(strClass, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.InstancesOfAsync(const objWbemSink: IDispatch; 
                                            const strClass: WideString; iFlags: Integer; 
                                            const objWbemNamedValueSet: IDispatch; 
                                            const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.InstancesOfAsync(objWbemSink, strClass, iFlags, objWbemNamedValueSet, 
...
function TSWbemServicesEx.SubclassesOf(const strSuperclass: WideString; iFlags: Integer; 
                                       const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.SubclassesOf(strSuperclass, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.SubclassesOfAsync(const objWbemSink: IDispatch; 
                                             const strSuperclass: WideString; iFlags: Integer; 
                                             const objWbemNamedValueSet: IDispatch; 
                                             const objWbemAsyncContext: IDispatch);
begin
...
function TSWbemServicesEx.ExecQuery(const strQuery: WideString; const strQueryLanguage: WideString; 
                                    iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.ExecQuery(strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.ExecQueryAsync(const objWbemSink: IDispatch; const strQuery: WideString; 
                                          const strQueryLanguage: WideString; lFlags: Integer; 
                                          const objWbemNamedValueSet: IDispatch; 
                                          const objWbemAsyncContext: IDispatch);
begin
...
function TSWbemServicesEx.AssociatorsOf(const strObjectPath: WideString; 
                                        const strAssocClass: WideString; 
                                        const strResultClass: WideString; 
                                        const strResultRole: WideString; const strRole: WideString; 
                                        bClassesOnly: WordBool; bSchemaOnly: WordBool; 
...
procedure TSWbemServicesEx.AssociatorsOfAsync(const objWbemSink: IDispatch; 
                                              const strObjectPath: WideString; 
                                              const strAssocClass: WideString; 
                                              const strResultClass: WideString; 
                                              const strResultRole: WideString; 
...
function TSWbemServicesEx.ReferencesTo(const strObjectPath: WideString; 
                                       const strResultClass: WideString; const strRole: WideString; 
                                       bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                       const strRequiredQualifier: WideString; iFlags: Integer; 
                                       const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
...
procedure TSWbemServicesEx.ReferencesToAsync(const objWbemSink: IDispatch; 
                                             const strObjectPath: WideString; 
                                             const strResultClass: WideString; 
                                             const strRole: WideString; bClassesOnly: WordBool; 
                                             bSchemaOnly: WordBool; 
...
function TSWbemServicesEx.ExecNotificationQuery(const strQuery: WideString; 
                                                const strQueryLanguage: WideString; 
                                                iFlags: Integer; 
                                                const objWbemNamedValueSet: IDispatch): ISWbemEventSource;
begin
...
procedure TSWbemServicesEx.ExecNotificationQueryAsync(const objWbemSink: IDispatch; 
                                                      const strQuery: WideString; 
                                                      const strQueryLanguage: WideString; 
                                                      iFlags: Integer; 
                                                      const objWbemNamedValueSet: IDispatch; 
...
function TSWbemServicesEx.ExecMethod(const strObjectPath: WideString; 
                                     const strMethodName: WideString; 
                                     const objWbemInParameters: IDispatch; iFlags: Integer; 
                                     const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
...
procedure TSWbemServicesEx.ExecMethodAsync(const objWbemSink: IDispatch; 
                                           const strObjectPath: WideString; 
                                           const strMethodName: WideString; 
                                           const objWbemInParameters: IDispatch; iFlags: Integer; 
                                           const objWbemNamedValueSet: IDispatch; 
...
function TSWbemServicesEx.Put(const objWbemObject: ISWbemObjectEx; iFlags: Integer; 
                              const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
begin
  Result := DefaultInterface.Put(objWbemObject, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemServicesEx.PutAsync(const objWbemSink: ISWbemSink; 
                                    const objWbemObject: ISWbemObjectEx; iFlags: Integer; 
                                    const objWbemNamedValueSet: IDispatch; 
                                    const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.PutAsync(objWbemSink, objWbemObject, iFlags, objWbemNamedValueSet, 
                            objWbemAsyncContext);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemServicesExProperties.Create(AServer: TSWbemServicesEx);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemServicesExProperties.GetDefaultInterface: ISWbemServicesEx;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemServicesExProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;
...
procedure TSWbemObject.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D62-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{76A6415A-CB41-11D1-8B02-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemObject.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemObject;
  end;
end;

procedure TSWbemObject.ConnectTo(svrIntf: ISWbemObject);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemObject.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemObject.GetDefaultInterface: ISWbemObject;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemObject.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemObjectProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemObject.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemObject.GetServerProperties: TSWbemObjectProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemObject.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemObject.Get_Properties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.Properties_;
end;

function TSWbemObject.Get_Methods_: ISWbemMethodSet;
begin
    Result := DefaultInterface.Methods_;
end;

function TSWbemObject.Get_Derivation_: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TSWbemObject.Get_Path_: ISWbemObjectPath;
begin
    Result := DefaultInterface.Path_;
end;

function TSWbemObject.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemObject.Put_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
begin
  Result := DefaultInterface.Put_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObject.PutAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                 const objWbemNamedValueSet: IDispatch; 
                                 const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.PutAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
procedure TSWbemObject.Delete_(iFlags: Integer; const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.Delete_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObject.DeleteAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                    const objWbemNamedValueSet: IDispatch; 
                                    const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.DeleteAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObject.Instances_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.Instances_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObject.InstancesAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                       const objWbemNamedValueSet: IDispatch; 
                                       const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.InstancesAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObject.Subclasses_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.Subclasses_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObject.SubclassesAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                        const objWbemNamedValueSet: IDispatch; 
                                        const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.SubclassesAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObject.Associators_(const strAssocClass: WideString; 
                                   const strResultClass: WideString; 
                                   const strResultRole: WideString; const strRole: WideString; 
                                   bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                   const strRequiredAssocQualifier: WideString; 
...
procedure TSWbemObject.AssociatorsAsync_(const objWbemSink: IDispatch; 
                                         const strAssocClass: WideString; 
                                         const strResultClass: WideString; 
                                         const strResultRole: WideString; 
                                         const strRole: WideString; bClassesOnly: WordBool; 
...
function TSWbemObject.References_(const strResultClass: WideString; const strRole: WideString; 
                                  bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                  const strRequiredQualifier: WideString; iFlags: Integer; 
                                  const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
...
procedure TSWbemObject.ReferencesAsync_(const objWbemSink: IDispatch; 
                                        const strResultClass: WideString; 
                                        const strRole: WideString; bClassesOnly: WordBool; 
                                        bSchemaOnly: WordBool; 
                                        const strRequiredQualifier: WideString; iFlags: Integer; 
...
function TSWbemObject.ExecMethod_(const strMethodName: WideString; 
                                  const objWbemInParameters: IDispatch; iFlags: Integer; 
                                  const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
  Result := DefaultInterface.ExecMethod_(strMethodName, objWbemInParameters, iFlags, 
...
procedure TSWbemObject.ExecMethodAsync_(const objWbemSink: IDispatch; 
                                        const strMethodName: WideString; 
                                        const objWbemInParameters: IDispatch; iFlags: Integer; 
                                        const objWbemNamedValueSet: IDispatch; 
                                        const objWbemAsyncContext: IDispatch);
...
function TSWbemObject.Clone_: ISWbemObject;
begin
  Result := DefaultInterface.Clone_;
end;

function TSWbemObject.GetObjectText_(iFlags: Integer): WideString;
begin
  Result := DefaultInterface.GetObjectText_(iFlags);
end;

function TSWbemObject.SpawnDerivedClass_(iFlags: Integer): ISWbemObject;
begin
  Result := DefaultInterface.SpawnDerivedClass_(iFlags);
end;

function TSWbemObject.SpawnInstance_(iFlags: Integer): ISWbemObject;
begin
  Result := DefaultInterface.SpawnInstance_(iFlags);
end;

function TSWbemObject.CompareTo_(const objWbemObject: IDispatch; iFlags: Integer): WordBool;
begin
  Result := DefaultInterface.CompareTo_(objWbemObject, iFlags);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemObjectProperties.Create(AServer: TSWbemObject);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemObjectProperties.GetDefaultInterface: ISWbemObject;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemObjectProperties.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemObjectProperties.Get_Properties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.Properties_;
end;

function TSWbemObjectProperties.Get_Methods_: ISWbemMethodSet;
begin
    Result := DefaultInterface.Methods_;
end;

function TSWbemObjectProperties.Get_Derivation_: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TSWbemObjectProperties.Get_Path_: ISWbemObjectPath;
begin
    Result := DefaultInterface.Path_;
end;

function TSWbemObjectProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;
...
procedure TSWbemObjectEx.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{D6BDAFB2-9435-491F-BB87-6AA0F0BC31A2}';
    IntfIID:   '{269AD56A-8A67-4129-BC8C-0506DCFE9880}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemObjectEx.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemObjectEx;
  end;
end;

procedure TSWbemObjectEx.ConnectTo(svrIntf: ISWbemObjectEx);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemObjectEx.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemObjectEx.GetDefaultInterface: ISWbemObjectEx;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemObjectEx.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemObjectExProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemObjectEx.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemObjectEx.GetServerProperties: TSWbemObjectExProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemObjectEx.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemObjectEx.Get_Properties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.Properties_;
end;

function TSWbemObjectEx.Get_Methods_: ISWbemMethodSet;
begin
    Result := DefaultInterface.Methods_;
end;

function TSWbemObjectEx.Get_Derivation_: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TSWbemObjectEx.Get_Path_: ISWbemObjectPath;
begin
    Result := DefaultInterface.Path_;
end;

function TSWbemObjectEx.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemObjectEx.Get_SystemProperties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.SystemProperties_;
end;

function TSWbemObjectEx.Put_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectPath;
begin
  Result := DefaultInterface.Put_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObjectEx.PutAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                   const objWbemNamedValueSet: IDispatch; 
                                   const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.PutAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
procedure TSWbemObjectEx.Delete_(iFlags: Integer; const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.Delete_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObjectEx.DeleteAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                      const objWbemNamedValueSet: IDispatch; 
                                      const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.DeleteAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObjectEx.Instances_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.Instances_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObjectEx.InstancesAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                         const objWbemNamedValueSet: IDispatch; 
                                         const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.InstancesAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObjectEx.Subclasses_(iFlags: Integer; const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
  Result := DefaultInterface.Subclasses_(iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObjectEx.SubclassesAsync_(const objWbemSink: IDispatch; iFlags: Integer; 
                                          const objWbemNamedValueSet: IDispatch; 
                                          const objWbemAsyncContext: IDispatch);
begin
  DefaultInterface.SubclassesAsync_(objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
...
function TSWbemObjectEx.Associators_(const strAssocClass: WideString; 
                                     const strResultClass: WideString; 
                                     const strResultRole: WideString; const strRole: WideString; 
                                     bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                     const strRequiredAssocQualifier: WideString; 
...
procedure TSWbemObjectEx.AssociatorsAsync_(const objWbemSink: IDispatch; 
                                           const strAssocClass: WideString; 
                                           const strResultClass: WideString; 
                                           const strResultRole: WideString; 
                                           const strRole: WideString; bClassesOnly: WordBool; 
...
function TSWbemObjectEx.References_(const strResultClass: WideString; const strRole: WideString; 
                                    bClassesOnly: WordBool; bSchemaOnly: WordBool; 
                                    const strRequiredQualifier: WideString; iFlags: Integer; 
                                    const objWbemNamedValueSet: IDispatch): ISWbemObjectSet;
begin
...
procedure TSWbemObjectEx.ReferencesAsync_(const objWbemSink: IDispatch; 
                                          const strResultClass: WideString; 
                                          const strRole: WideString; bClassesOnly: WordBool; 
                                          bSchemaOnly: WordBool; 
                                          const strRequiredQualifier: WideString; iFlags: Integer; 
...
function TSWbemObjectEx.ExecMethod_(const strMethodName: WideString; 
                                    const objWbemInParameters: IDispatch; iFlags: Integer; 
                                    const objWbemNamedValueSet: IDispatch): ISWbemObject;
begin
  Result := DefaultInterface.ExecMethod_(strMethodName, objWbemInParameters, iFlags, 
...
procedure TSWbemObjectEx.ExecMethodAsync_(const objWbemSink: IDispatch; 
                                          const strMethodName: WideString; 
                                          const objWbemInParameters: IDispatch; iFlags: Integer; 
                                          const objWbemNamedValueSet: IDispatch; 
                                          const objWbemAsyncContext: IDispatch);
...
function TSWbemObjectEx.Clone_: ISWbemObject;
begin
  Result := DefaultInterface.Clone_;
end;

function TSWbemObjectEx.GetObjectText_(iFlags: Integer): WideString;
begin
  Result := DefaultInterface.GetObjectText_(iFlags);
end;

function TSWbemObjectEx.SpawnDerivedClass_(iFlags: Integer): ISWbemObject;
begin
  Result := DefaultInterface.SpawnDerivedClass_(iFlags);
end;

function TSWbemObjectEx.SpawnInstance_(iFlags: Integer): ISWbemObject;
begin
  Result := DefaultInterface.SpawnInstance_(iFlags);
end;

function TSWbemObjectEx.CompareTo_(const objWbemObject: IDispatch; iFlags: Integer): WordBool;
begin
  Result := DefaultInterface.CompareTo_(objWbemObject, iFlags);
end;

procedure TSWbemObjectEx.Refresh_(iFlags: Integer; const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.Refresh_(iFlags, objWbemNamedValueSet);
end;

function TSWbemObjectEx.GetText_(iObjectTextFormat: WbemObjectTextFormatEnum; iFlags: Integer; 
                                 const objWbemNamedValueSet: IDispatch): WideString;
begin
  Result := DefaultInterface.GetText_(iObjectTextFormat, iFlags, objWbemNamedValueSet);
end;

procedure TSWbemObjectEx.SetFromText_(const bsText: WideString; 
                                      iObjectTextFormat: WbemObjectTextFormatEnum; iFlags: Integer; 
                                      const objWbemNamedValueSet: IDispatch);
begin
  DefaultInterface.SetFromText_(bsText, iObjectTextFormat, iFlags, objWbemNamedValueSet);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemObjectExProperties.Create(AServer: TSWbemObjectEx);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemObjectExProperties.GetDefaultInterface: ISWbemObjectEx;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemObjectExProperties.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemObjectExProperties.Get_Properties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.Properties_;
end;

function TSWbemObjectExProperties.Get_Methods_: ISWbemMethodSet;
begin
    Result := DefaultInterface.Methods_;
end;

function TSWbemObjectExProperties.Get_Derivation_: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TSWbemObjectExProperties.Get_Path_: ISWbemObjectPath;
begin
    Result := DefaultInterface.Path_;
end;

function TSWbemObjectExProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemObjectExProperties.Get_SystemProperties_: ISWbemPropertySet;
begin
    Result := DefaultInterface.SystemProperties_;
end;
...
procedure TSWbemObjectSet.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D61-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{76A6415F-CB41-11D1-8B02-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemObjectSet.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemObjectSet;
  end;
end;

procedure TSWbemObjectSet.ConnectTo(svrIntf: ISWbemObjectSet);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemObjectSet.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemObjectSet.GetDefaultInterface: ISWbemObjectSet;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemObjectSet.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemObjectSetProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemObjectSet.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemObjectSet.GetServerProperties: TSWbemObjectSetProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemObjectSet.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemObjectSet.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemObjectSet.Item(const strObjectPath: WideString; iFlags: Integer): ISWbemObject;
begin
  Result := DefaultInterface.Item(strObjectPath, iFlags);
end;

function TSWbemObjectSet.ItemIndex(lIndex: Integer): ISWbemObject;
begin
  Result := DefaultInterface.ItemIndex(lIndex);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemObjectSetProperties.Create(AServer: TSWbemObjectSet);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemObjectSetProperties.GetDefaultInterface: ISWbemObjectSet;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemObjectSetProperties.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemObjectSetProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;
...
procedure TSWbemNamedValue.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D60-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{76A64164-CB41-11D1-8B02-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemNamedValue.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemNamedValue;
  end;
end;

procedure TSWbemNamedValue.ConnectTo(svrIntf: ISWbemNamedValue);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemNamedValue.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemNamedValue.GetDefaultInterface: ISWbemNamedValue;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemNamedValue.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemNamedValueProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemNamedValue.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemNamedValue.GetServerProperties: TSWbemNamedValueProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemNamedValue.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemNamedValue.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Value := varValue;
end;

function TSWbemNamedValue.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemNamedValueProperties.Create(AServer: TSWbemNamedValue);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemNamedValueProperties.GetDefaultInterface: ISWbemNamedValue;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemNamedValueProperties.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemNamedValueProperties.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TSWbemNamedValueProperties.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;
...
procedure TSWbemQualifier.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5F-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{79B05932-D3B7-11D1-8B06-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemQualifier.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemQualifier;
  end;
end;

procedure TSWbemQualifier.ConnectTo(svrIntf: ISWbemQualifier);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemQualifier.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemQualifier.GetDefaultInterface: ISWbemQualifier;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemQualifier.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemQualifierProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemQualifier.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemQualifier.GetServerProperties: TSWbemQualifierProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemQualifier.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemQualifier.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TSWbemQualifier.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemQualifier.Get_IsLocal: WordBool;
begin
    Result := DefaultInterface.IsLocal;
end;

function TSWbemQualifier.Get_PropagatesToSubclass: WordBool;
begin
    Result := DefaultInterface.PropagatesToSubclass;
end;

procedure TSWbemQualifier.Set_PropagatesToSubclass(bPropagatesToSubclass: WordBool);
begin
  DefaultInterface.Set_PropagatesToSubclass(bPropagatesToSubclass);
end;

function TSWbemQualifier.Get_PropagatesToInstance: WordBool;
begin
    Result := DefaultInterface.PropagatesToInstance;
end;

procedure TSWbemQualifier.Set_PropagatesToInstance(bPropagatesToInstance: WordBool);
begin
  DefaultInterface.Set_PropagatesToInstance(bPropagatesToInstance);
end;

function TSWbemQualifier.Get_IsOverridable: WordBool;
begin
    Result := DefaultInterface.IsOverridable;
end;

procedure TSWbemQualifier.Set_IsOverridable(bIsOverridable: WordBool);
begin
  DefaultInterface.Set_IsOverridable(bIsOverridable);
end;

function TSWbemQualifier.Get_IsAmended: WordBool;
begin
    Result := DefaultInterface.IsAmended;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemQualifierProperties.Create(AServer: TSWbemQualifier);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemQualifierProperties.GetDefaultInterface: ISWbemQualifier;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemQualifierProperties.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemQualifierProperties.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TSWbemQualifierProperties.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemQualifierProperties.Get_IsLocal: WordBool;
begin
    Result := DefaultInterface.IsLocal;
end;

function TSWbemQualifierProperties.Get_PropagatesToSubclass: WordBool;
begin
    Result := DefaultInterface.PropagatesToSubclass;
end;

procedure TSWbemQualifierProperties.Set_PropagatesToSubclass(bPropagatesToSubclass: WordBool);
begin
  DefaultInterface.Set_PropagatesToSubclass(bPropagatesToSubclass);
end;

function TSWbemQualifierProperties.Get_PropagatesToInstance: WordBool;
begin
    Result := DefaultInterface.PropagatesToInstance;
end;

procedure TSWbemQualifierProperties.Set_PropagatesToInstance(bPropagatesToInstance: WordBool);
begin
  DefaultInterface.Set_PropagatesToInstance(bPropagatesToInstance);
end;

function TSWbemQualifierProperties.Get_IsOverridable: WordBool;
begin
    Result := DefaultInterface.IsOverridable;
end;

procedure TSWbemQualifierProperties.Set_IsOverridable(bIsOverridable: WordBool);
begin
  DefaultInterface.Set_IsOverridable(bIsOverridable);
end;

function TSWbemQualifierProperties.Get_IsAmended: WordBool;
begin
    Result := DefaultInterface.IsAmended;
end;
...
procedure TSWbemQualifierSet.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5E-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{9B16ED16-D3DF-11D1-8B08-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemQualifierSet.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemQualifierSet;
  end;
end;

procedure TSWbemQualifierSet.ConnectTo(svrIntf: ISWbemQualifierSet);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemQualifierSet.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemQualifierSet.GetDefaultInterface: ISWbemQualifierSet;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemQualifierSet.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemQualifierSetProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemQualifierSet.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemQualifierSet.GetServerProperties: TSWbemQualifierSetProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemQualifierSet.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemQualifierSet.Item(const Name: WideString; iFlags: Integer): ISWbemQualifier;
begin
  Result := DefaultInterface.Item(Name, iFlags);
end;

function TSWbemQualifierSet.Add(const strName: WideString; var varVal: OleVariant; 
                                bPropagatesToSubclass: WordBool; bPropagatesToInstance: WordBool; 
                                bIsOverridable: WordBool; iFlags: Integer): ISWbemQualifier;
begin
  Result := DefaultInterface.Add(strName, varVal, bPropagatesToSubclass, bPropagatesToInstance, 
                                 bIsOverridable, iFlags);
end;

procedure TSWbemQualifierSet.Remove(const strName: WideString; iFlags: Integer);
begin
  DefaultInterface.Remove(strName, iFlags);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemQualifierSetProperties.Create(AServer: TSWbemQualifierSet);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemQualifierSetProperties.GetDefaultInterface: ISWbemQualifierSet;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemQualifierSetProperties.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;
...
procedure TSWbemProperty.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5D-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{1A388F98-D4BA-11D1-8B09-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemProperty.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemProperty;
  end;
end;

procedure TSWbemProperty.ConnectTo(svrIntf: ISWbemProperty);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemProperty.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemProperty.GetDefaultInterface: ISWbemProperty;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemProperty.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemPropertyProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemProperty.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemProperty.GetServerProperties: TSWbemPropertyProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemProperty.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemProperty.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TSWbemProperty.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemProperty.Get_IsLocal: WordBool;
begin
    Result := DefaultInterface.IsLocal;
end;

function TSWbemProperty.Get_Origin: WideString;
begin
    Result := DefaultInterface.Origin;
end;

function TSWbemProperty.Get_CIMType: WbemCimtypeEnum;
begin
    Result := DefaultInterface.CIMType;
end;

function TSWbemProperty.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemProperty.Get_IsArray: WordBool;
begin
    Result := DefaultInterface.IsArray;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemPropertyProperties.Create(AServer: TSWbemProperty);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemPropertyProperties.GetDefaultInterface: ISWbemProperty;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemPropertyProperties.Get_Value: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TSWbemPropertyProperties.Set_Value(var varValue: OleVariant);
  { Warning: The property Value has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TSWbemPropertyProperties.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemPropertyProperties.Get_IsLocal: WordBool;
begin
    Result := DefaultInterface.IsLocal;
end;

function TSWbemPropertyProperties.Get_Origin: WideString;
begin
    Result := DefaultInterface.Origin;
end;

function TSWbemPropertyProperties.Get_CIMType: WbemCimtypeEnum;
begin
    Result := DefaultInterface.CIMType;
end;

function TSWbemPropertyProperties.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

function TSWbemPropertyProperties.Get_IsArray: WordBool;
begin
    Result := DefaultInterface.IsArray;
end;
...
procedure TSWbemPropertySet.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5C-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{DEA0A7B2-D4BA-11D1-8B09-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemPropertySet.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemPropertySet;
  end;
end;

procedure TSWbemPropertySet.ConnectTo(svrIntf: ISWbemPropertySet);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemPropertySet.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemPropertySet.GetDefaultInterface: ISWbemPropertySet;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemPropertySet.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemPropertySetProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemPropertySet.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemPropertySet.GetServerProperties: TSWbemPropertySetProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemPropertySet.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemPropertySet.Item(const strName: WideString; iFlags: Integer): ISWbemProperty;
begin
  Result := DefaultInterface.Item(strName, iFlags);
end;

function TSWbemPropertySet.Add(const strName: WideString; iCimType: WbemCimtypeEnum; 
                               bIsArray: WordBool; iFlags: Integer): ISWbemProperty;
begin
  Result := DefaultInterface.Add(strName, iCimType, bIsArray, iFlags);
end;

procedure TSWbemPropertySet.Remove(const strName: WideString; iFlags: Integer);
begin
  DefaultInterface.Remove(strName, iFlags);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemPropertySetProperties.Create(AServer: TSWbemPropertySet);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemPropertySetProperties.GetDefaultInterface: ISWbemPropertySet;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemPropertySetProperties.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;
...
procedure TSWbemMethod.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5B-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{422E8E90-D955-11D1-8B09-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemMethod.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemMethod;
  end;
end;

procedure TSWbemMethod.ConnectTo(svrIntf: ISWbemMethod);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemMethod.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemMethod.GetDefaultInterface: ISWbemMethod;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemMethod.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemMethodProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemMethod.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemMethod.GetServerProperties: TSWbemMethodProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemMethod.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemMethod.Get_Origin: WideString;
begin
    Result := DefaultInterface.Origin;
end;

function TSWbemMethod.Get_InParameters: ISWbemObject;
begin
    Result := DefaultInterface.InParameters;
end;

function TSWbemMethod.Get_OutParameters: ISWbemObject;
begin
    Result := DefaultInterface.OutParameters;
end;

function TSWbemMethod.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemMethodProperties.Create(AServer: TSWbemMethod);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemMethodProperties.GetDefaultInterface: ISWbemMethod;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemMethodProperties.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemMethodProperties.Get_Origin: WideString;
begin
    Result := DefaultInterface.Origin;
end;

function TSWbemMethodProperties.Get_InParameters: ISWbemObject;
begin
    Result := DefaultInterface.InParameters;
end;

function TSWbemMethodProperties.Get_OutParameters: ISWbemObject;
begin
    Result := DefaultInterface.OutParameters;
end;

function TSWbemMethodProperties.Get_Qualifiers_: ISWbemQualifierSet;
begin
    Result := DefaultInterface.Qualifiers_;
end;
...
procedure TSWbemMethodSet.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D5A-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{C93BA292-D955-11D1-8B09-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemMethodSet.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemMethodSet;
  end;
end;

procedure TSWbemMethodSet.ConnectTo(svrIntf: ISWbemMethodSet);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemMethodSet.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemMethodSet.GetDefaultInterface: ISWbemMethodSet;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemMethodSet.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemMethodSetProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemMethodSet.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemMethodSet.GetServerProperties: TSWbemMethodSetProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemMethodSet.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemMethodSet.Item(const strName: WideString; iFlags: Integer): ISWbemMethod;
begin
  Result := DefaultInterface.Item(strName, iFlags);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemMethodSetProperties.Create(AServer: TSWbemMethodSet);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemMethodSetProperties.GetDefaultInterface: ISWbemMethodSet;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemMethodSetProperties.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;
...
procedure TSWbemEventSource.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{04B83D58-21AE-11D2-8B33-00600806D9B6}';
    IntfIID:   '{27D54D92-0EBE-11D2-8B22-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemEventSource.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemEventSource;
  end;
end;

procedure TSWbemEventSource.ConnectTo(svrIntf: ISWbemEventSource);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemEventSource.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemEventSource.GetDefaultInterface: ISWbemEventSource;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemEventSource.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemEventSourceProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemEventSource.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemEventSource.GetServerProperties: TSWbemEventSourceProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemEventSource.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;

function TSWbemEventSource.NextEvent(iTimeoutMs: Integer): ISWbemObject;
begin
  Result := DefaultInterface.NextEvent(iTimeoutMs);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemEventSourceProperties.Create(AServer: TSWbemEventSource);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemEventSourceProperties.GetDefaultInterface: ISWbemEventSource;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemEventSourceProperties.Get_Security_: ISWbemSecurity;
begin
    Result := DefaultInterface.Security_;
end;
...
procedure TSWbemSecurity.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{B54D66E9-2287-11D2-8B33-00600806D9B6}';
    IntfIID:   '{B54D66E6-2287-11D2-8B33-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemSecurity.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemSecurity;
  end;
end;

procedure TSWbemSecurity.ConnectTo(svrIntf: ISWbemSecurity);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemSecurity.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemSecurity.GetDefaultInterface: ISWbemSecurity;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemSecurity.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemSecurityProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemSecurity.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemSecurity.GetServerProperties: TSWbemSecurityProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemSecurity.Get_ImpersonationLevel: WbemImpersonationLevelEnum;
begin
    Result := DefaultInterface.ImpersonationLevel;
end;

procedure TSWbemSecurity.Set_ImpersonationLevel(iImpersonationLevel: WbemImpersonationLevelEnum);
begin
  DefaultInterface.Set_ImpersonationLevel(iImpersonationLevel);
end;

function TSWbemSecurity.Get_AuthenticationLevel: WbemAuthenticationLevelEnum;
begin
    Result := DefaultInterface.AuthenticationLevel;
end;

procedure TSWbemSecurity.Set_AuthenticationLevel(iAuthenticationLevel: WbemAuthenticationLevelEnum);
begin
  DefaultInterface.Set_AuthenticationLevel(iAuthenticationLevel);
end;

function TSWbemSecurity.Get_Privileges: ISWbemPrivilegeSet;
begin
    Result := DefaultInterface.Privileges;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemSecurityProperties.Create(AServer: TSWbemSecurity);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemSecurityProperties.GetDefaultInterface: ISWbemSecurity;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemSecurityProperties.Get_ImpersonationLevel: WbemImpersonationLevelEnum;
begin
    Result := DefaultInterface.ImpersonationLevel;
end;

procedure TSWbemSecurityProperties.Set_ImpersonationLevel(iImpersonationLevel: WbemImpersonationLevelEnum);
begin
  DefaultInterface.Set_ImpersonationLevel(iImpersonationLevel);
end;

function TSWbemSecurityProperties.Get_AuthenticationLevel: WbemAuthenticationLevelEnum;
begin
    Result := DefaultInterface.AuthenticationLevel;
end;

procedure TSWbemSecurityProperties.Set_AuthenticationLevel(iAuthenticationLevel: WbemAuthenticationLevelEnum);
begin
  DefaultInterface.Set_AuthenticationLevel(iAuthenticationLevel);
end;

function TSWbemSecurityProperties.Get_Privileges: ISWbemPrivilegeSet;
begin
    Result := DefaultInterface.Privileges;
end;
...
procedure TSWbemPrivilege.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{26EE67BC-5804-11D2-8B4A-00600806D9B6}';
    IntfIID:   '{26EE67BD-5804-11D2-8B4A-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemPrivilege.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemPrivilege;
  end;
end;

procedure TSWbemPrivilege.ConnectTo(svrIntf: ISWbemPrivilege);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemPrivilege.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemPrivilege.GetDefaultInterface: ISWbemPrivilege;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemPrivilege.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemPrivilegeProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemPrivilege.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemPrivilege.GetServerProperties: TSWbemPrivilegeProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemPrivilege.Get_IsEnabled: WordBool;
begin
    Result := DefaultInterface.IsEnabled;
end;

procedure TSWbemPrivilege.Set_IsEnabled(bIsEnabled: WordBool);
begin
  DefaultInterface.Set_IsEnabled(bIsEnabled);
end;

function TSWbemPrivilege.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemPrivilege.Get_DisplayName: WideString;
begin
    Result := DefaultInterface.DisplayName;
end;

function TSWbemPrivilege.Get_Identifier: WbemPrivilegeEnum;
begin
    Result := DefaultInterface.Identifier;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemPrivilegeProperties.Create(AServer: TSWbemPrivilege);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemPrivilegeProperties.GetDefaultInterface: ISWbemPrivilege;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemPrivilegeProperties.Get_IsEnabled: WordBool;
begin
    Result := DefaultInterface.IsEnabled;
end;

procedure TSWbemPrivilegeProperties.Set_IsEnabled(bIsEnabled: WordBool);
begin
  DefaultInterface.Set_IsEnabled(bIsEnabled);
end;

function TSWbemPrivilegeProperties.Get_Name: WideString;
begin
    Result := DefaultInterface.Name;
end;

function TSWbemPrivilegeProperties.Get_DisplayName: WideString;
begin
    Result := DefaultInterface.DisplayName;
end;

function TSWbemPrivilegeProperties.Get_Identifier: WbemPrivilegeEnum;
begin
    Result := DefaultInterface.Identifier;
end;
...
procedure TSWbemPrivilegeSet.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{26EE67BE-5804-11D2-8B4A-00600806D9B6}';
    IntfIID:   '{26EE67BF-5804-11D2-8B4A-00600806D9B6}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemPrivilegeSet.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemPrivilegeSet;
  end;
end;

procedure TSWbemPrivilegeSet.ConnectTo(svrIntf: ISWbemPrivilegeSet);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemPrivilegeSet.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemPrivilegeSet.GetDefaultInterface: ISWbemPrivilegeSet;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemPrivilegeSet.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemPrivilegeSetProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemPrivilegeSet.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemPrivilegeSet.GetServerProperties: TSWbemPrivilegeSetProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemPrivilegeSet.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;

function TSWbemPrivilegeSet.Item(iPrivilege: WbemPrivilegeEnum): ISWbemPrivilege;
begin
  Result := DefaultInterface.Item(iPrivilege);
end;

function TSWbemPrivilegeSet.Add(iPrivilege: WbemPrivilegeEnum; bIsEnabled: WordBool): ISWbemPrivilege;
begin
  Result := DefaultInterface.Add(iPrivilege, bIsEnabled);
end;

procedure TSWbemPrivilegeSet.Remove(iPrivilege: WbemPrivilegeEnum);
begin
  DefaultInterface.Remove(iPrivilege);
end;

procedure TSWbemPrivilegeSet.DeleteAll;
begin
  DefaultInterface.DeleteAll;
end;

function TSWbemPrivilegeSet.AddAsString(const strPrivilege: WideString; bIsEnabled: WordBool): ISWbemPrivilege;
begin
  Result := DefaultInterface.AddAsString(strPrivilege, bIsEnabled);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemPrivilegeSetProperties.Create(AServer: TSWbemPrivilegeSet);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemPrivilegeSetProperties.GetDefaultInterface: ISWbemPrivilegeSet;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemPrivilegeSetProperties.Get_Count: Integer;
begin
    Result := DefaultInterface.Count;
end;
...
procedure TSWbemRefreshableItem.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{8C6854BC-DE4B-11D3-B390-00105A1F473A}';
    IntfIID:   '{5AD4BF92-DAAB-11D3-B38F-00105A1F473A}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSWbemRefreshableItem.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISWbemRefreshableItem;
  end;
end;

procedure TSWbemRefreshableItem.ConnectTo(svrIntf: ISWbemRefreshableItem);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSWbemRefreshableItem.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSWbemRefreshableItem.GetDefaultInterface: ISWbemRefreshableItem;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSWbemRefreshableItem.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TSWbemRefreshableItemProperties.Create(Self);
{$ENDIF}
end;

destructor TSWbemRefreshableItem.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TSWbemRefreshableItem.GetServerProperties: TSWbemRefreshableItemProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TSWbemRefreshableItem.Get_Index: Integer;
begin
    Result := DefaultInterface.Index;
end;

function TSWbemRefreshableItem.Get_Refresher: ISWbemRefresher;
begin
    Result := DefaultInterface.Refresher;
end;

function TSWbemRefreshableItem.Get_IsSet: WordBool;
begin
    Result := DefaultInterface.IsSet;
end;

function TSWbemRefreshableItem.Get_Object_: ISWbemObjectEx;
begin
    Result := DefaultInterface.Object_;
end;

function TSWbemRefreshableItem.Get_ObjectSet: ISWbemObjectSet;
begin
    Result := DefaultInterface.ObjectSet;
end;

procedure TSWbemRefreshableItem.Remove(iFlags: Integer);
begin
  DefaultInterface.Remove(iFlags);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TSWbemRefreshableItemProperties.Create(AServer: TSWbemRefreshableItem);
begin
  inherited Create;
  FServer := AServer;
end;

function TSWbemRefreshableItemProperties.GetDefaultInterface: ISWbemRefreshableItem;
begin
  Result := FServer.DefaultInterface;
end;

function TSWbemRefreshableItemProperties.Get_Index: Integer;
begin
    Result := DefaultInterface.Index;
end;

function TSWbemRefreshableItemProperties.Get_Refresher: ISWbemRefresher;
begin
    Result := DefaultInterface.Refresher;
end;

function TSWbemRefreshableItemProperties.Get_IsSet: WordBool;
begin
    Result := DefaultInterface.IsSet;
end;

function TSWbemRefreshableItemProperties.Get_Object_: ISWbemObjectEx;
begin
    Result := DefaultInterface.Object_;
end;

function TSWbemRefreshableItemProperties.Get_ObjectSet: ISWbemObjectSet;
begin
    Result := DefaultInterface.ObjectSet;
end;
...
begin
  RegisterComponents(dtlServerPage, [TSWbemLocator, TSWbemNamedValueSet, TSWbemObjectPath, TSWbemLastError, 
    TSWbemSink, TSWbemDateTime, TSWbemRefresher, TSWbemServices, TSWbemServicesEx, 
    TSWbemObject, TSWbemObjectEx, TSWbemObjectSet, TSWbemNamedValue, TSWbemQualifier, 
    TSWbemQualifierSet, TSWbemProperty, TSWbemPropertySet, TSWbemMethod, TSWbemMethodSet, 
    TSWbemEventSource, TSWbemSecurity, TSWbemPrivilege, TSWbemPrivilegeSet, TSWbemRefreshableItem]);
end;
