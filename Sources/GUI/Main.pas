...
begin
  ...
  begin
    ...
    // IOmniThreadPool - возможно, стоит для кучи потоков использовать его,
    // причём в модуле WMIDataCollector тоже.
    { TODO : см. выше }
  end;
end;
...
procedure TfrmMain.lvWorkstationsCreateItemClass(Sender: TCustomListView;
  var ItemClass: TListItemClass);
begin
  // Запоминаем, что текущее изменение - это создание нового элемента:
